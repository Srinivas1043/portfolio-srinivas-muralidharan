  ...
  const contactInfo = [
    {
      ...
      label: 'Email',
      value: 'sm1043@gmail.com',
      link: 'mailto:sm1043@gmail.com'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      label: 'LinkedIn',
      value: '/in/srinivas-muralidharan',
      link: 'https://linkedin.com/in/srinivas-muralidharan'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      label: 'GitHub',
      value: '@Srinivas1043',
      link: 'https://github.com/Srinivas1043'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const socialLinks = [
    {
      ...
      url: 'https://twitter.com/srinivas_ai'
    },
    {
      name: 'LinkedIn',
      icon: (
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                Whether you're looking to collaborate on cutting-edge AI projects, 
                need expertise in data engineering, or want to discuss the latest 
                developments in machine learning, I'd love to hear from you.
              </p>
            </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {submitStatus === 'error' && (
                <div className="text-center p-4 bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200 rounded-lg">
